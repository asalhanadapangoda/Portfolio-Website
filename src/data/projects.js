...
export const projects = [
  ...
  },
  {
    ...
    type: 'Individual',
    description:
      'Agricultural decision support tool that recommends optimal crops using machine learning models trained on soil and environmental data.',
    category: 'ai-ml',
    language: 'Python',
  ...
  },
  {
    ...
    type: 'Individual',
    description:
      'Machine learning system that predicts heart disease risk levels from clinical health data using TensorFlow neural networks, Flask, and React.',
    category: 'ai-ml',
    language: 'Python',
    technologies: ['Python', 'TensorFlow', 'Scikit-learn', 'Flask', 'React'],
